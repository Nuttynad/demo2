...
export class DiscoverPage {
  ...
  // getAllJobs() { 
  //   let self = this
  //   self.jobService.getAll().then(function (result) { //calls service
  ...
  addToBookmarks(job) {
    this.jobService.addToBookmarks(job).then(function (result) {
      console.log("Successfully added " +job.JobTitle+ " to bookmarks")
    })
  }
